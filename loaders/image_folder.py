...
class DAVISFourierImageFolder(data.Dataset):
...
# For supervision with MVS gt depth
#This loader includes fourier feature mapping
class SupervisionFourierImageFolder(data.Dataset):
...
# For supervision with MVS gt depth and Latent Constraint loss
class SupervisionLatentImageFolder(data.Dataset):
