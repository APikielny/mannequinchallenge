...
parser.add_argument('--aligning_adam_translate_videos', action='store_true',
...
def compute_accuracy_for_id(id, dataset, model_name, method = "median_scale"):
    ...
    if args.aligning_adam_translate_videos:
        ms = []
        bs = []
        testing_dir = '../test_data/viz_predictions/{}/{}/epoch_{}'.format("adam_translate", model_name, args.epoch)
...
if not args.aligning_adam_translate_videos:
